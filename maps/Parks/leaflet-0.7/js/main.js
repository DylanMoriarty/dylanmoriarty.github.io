...
NEP.innerHTML = '<img src="img/parks/NortheastRegional.png"/>';

var PAL = document.createElement('DIV')
PAL.innerHTML = '<img src ="img/parks/Palmer.png"/>';

var ROC = document.createElement('DIV')
ROC.innerHTML = '<img src ="img/parks/RockportPark.png"/>';

var RIV = document.createElement('DIV')
RIV.innerHTML = '<img src = "img/parks/RiversidePark.png"/>';

var BON = document.createElement('DIV')
BON.innerHTML = '<img src = "img/parks/BondPark.png"/>';

var KIW = document.createElement('DIV')
KIW.innerHTML = '<img src = "img/parks/Kiwansis.png"/>';

var LUS = document.createElement('DIV')
LUS.innerHTML = '<img src = "img/parks/LustigPark.png"/>';

var MON = document.createElement('DIV')
MON.innerHTML = '<img src = "img/parks/Monterey.png"/>';

var OPT = document.createElement('DIV')
OPT.innerHTML = '<img src = "img/parks/Optimist.png"/>';

var TRX = document.createElement('DIV')
TRX.innerHTML = '<img src = "img/parks/Traxler.png"/>';

var ADM = document.createElement('DIV')
ADM.innerHTML = '<img src = "img/parks/Adams.png"/>';

var ARD = document.createElement('DIV')
ARD.innerHTML = '<img src = "img/parks/Ardon.png"/>';

var BRI = document.createElement('DIV')
BRI.innerHTML = '<img src = "img/parks/Briacrest.png"/>';

var BUR = document.createElement('DIV')
BUR.innerHTML = '<img src = "img//parks/Burbank.png"/>';

var CLR = document.createElement('DIV')
CLR.innerHTML = '<img src = "img/parks/Claremont.png"/>';

var CRT = document.createElement('DIV')
CRT.innerHTML = '<img src = "img/parks/Court.png"/>';

var EXC = document.createElement('DIV')
EXC.innerHTML = '<img src = "img/parks/Excalibur.png"/>';

var FRW = document.createElement('DIV')
FRW.innerHTML = '<img src = "img/parks/Fourth.png"/>';

var HMP = document.createElement('DIV')
HMP.innerHTML = '<img src = "img/parks/Hampshire.png"/>';

var HAR = document.createElement('DIV')
HAR.innerHTML = '<img src = "img/parks/Harmony.png"/>';

var HAW = document.createElement('DIV')
HAW.innerHTML = '<img src = "img/parks/Hawthrone.png"/>';

var HOL = document.createElement('DIV')
HOL.innerHTML = '<img src = "img/parks/Holiday.png"/>';

var HUR = document.createElement('DIV')
HUR.innerHTML = '<img src = "img/parks/Huron.png"/>';

var JEF = document.createElement('DIV')
JEF.innerHTML = '<img src = "img/parks/Holiday.png"/>';

var JFS = document.createElement('DIV')
JFS.innerHTML = '<img src = "img/parks/Jeffris.png"/>';

var LOC = document.createElement('DIV')
LOC.innerHTML = '<img src = "img/parks/Loch.png"/>';

var MAN = document.createElement('DIV')
MAN.innerHTML = '<img src = "img/parks/Mandale.png"/>';

var MAR = document.createElement('DIV')
MAR.innerHTML = '<img src = "img/parks/Marquette.png"/>';

var NAN = document.createElement('DIV')
NAN.innerHTML = '<img src = "img/parks/Nantucket.png"/>';

var PAR = document.createElement('DIV')
PAR.innerHTML = '<img src = "img/parks/Parker.png"/>';

var PCE = document.createElement('DIV')
PCE.innerHTML = '<img src = "img/parks/Peace.png"/>';

var PER = document.createElement('DIV')
PER.innerHTML = '<img src = "img/parks/Pershing.png"/>'

var PRA = document.createElement('DIV')
PRA.innerHTML = '<img src = "img/parks/Prairie.png"/>';

var RUG = document.createElement('DIV')
RUG.innerHTML = '<img src = "img/parks/Ruger.png"/>';

var RUS = document.createElement('DIV')
RUS.innerHTML = '<img src = "img/parks/Rushmore.png"/>';

var SHE = document.createElement('DIV')
SHE.innerHTML = '<img src = "img/parks/Sherwood.png"/>';

var SOU = document.createElement('DIV')
SOU.innerHTML = '<img src = "img/parks/Southgate.png"/>';

var VAL = document.createElement('DIV')
VAL.innerHTML = '<img src = "img/parks/Valley.png"/>';

var VIS = document.createElement('DIV')
VIS.innerHTML = '<img src = "img/parks/Vista.png"/>';

var FAL = document.createElement('DIV')
FAL.innerHTML = '<img src = "img/parks/parks/Falcon.png"/>';

var WAV = document.createElement('DIV')
WAV.innerHTML = '<img src = "img/parks/Waveland.png"/>';

var WOD = document.createElement('DIV')
WOD.innerHTML = '<img src = "img/parks/Woodcrest.png"/>';

var ZON = document.createElement('DIV')
ZON.innerHTML = '<img src = "img/parks/Zonta.png"/>';
...
//RIV.innerHTML = '<img src ="img/Riverside.png"/>';

//var ROCK = document.createElement('DIV')
//ROC.innerHTML = '<img src = "img/Rockport.png"/>';

//var BOND = document.createElement('DIV')
//BON.innerHTML = '<img src = "img/Bond.png"/>';
...
//divNode.innerHTML = '<img src="img/Palmer.png"/>';
